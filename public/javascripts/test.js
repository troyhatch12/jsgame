...
map[4] = [0, 0, 1, 0, 0, 0, 0, 0, 0, 1, 0, 1];
map[5] = [0, 1, 0, 1, 0, 0, 0, 0, 0, 1, 0, 1];
map[6] = [0, 1, 0, 1, 0, 0, 0, 0, 0, 1, 0, 1];
map[7] = [0, 1, 0, 1, 0, 0, 0, 0, 0, 1, 0, 1];
map[8] = [0, 1, 0, 1, 0, 0, 0, 0, 1, 1, 0, 1];
...
// let point = perlin.get(1, 1);
// console.log("Point: ", point);
// console.log("Point2: ", perlin.get(25, 25));
...
/*
* Loop through all the tiles on the screen and draw them accordingly
*/
